...
import { Network, Loader2, User, Mail, Lock } from 'lucide-react';
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-neutral-900 via-neutral-950 to-black px-4 py-12">
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          >
            Get started with Context AI today
          </motion.p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-4 top-4 h-5 w-5 text-neutral-500 pointer-events-none" />
                <Input
                  id="name"
                  type="text"
                  value={name}
